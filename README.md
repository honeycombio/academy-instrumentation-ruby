...
Go to [Gitpod](https://gitpod.io/#https://github.com/honeycombio/academy-instrumentation-ruby) to open the repository.
...
```bash
git clone https://github.com/honeycombio/academy-instrumentation-ruby
```
